...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MCNAEdu ERP — ERP Management System" },
      { name: "description", content: "MCNAEdu ERP — multi-branch ERP for academic centers. Manage students, classes, schedules, tuition, and payroll." },
      { property: "og:title", content: "MCNAEdu ERP — ERP Management System" },
      { name: "twitter:title", content: "MCNAEdu ERP — ERP Management System" },
      { property: "og:description", content: "MCNAEdu ERP — multi-branch ERP for academic centers. Manage students, classes, schedules, tuition, and payroll." },
      { name: "twitter:description", content: "MCNAEdu ERP — multi-branch ERP for academic centers. Manage students, classes, schedules, tuition, and payroll." },
